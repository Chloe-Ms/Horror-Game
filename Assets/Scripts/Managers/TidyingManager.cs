...
public class TidyingManager : MonoBehaviour
{
    ...
    void InitializeObjectMap()
    {
        ...
        ObjectInteractable[] objectsInteractable = FindObjectsByType<ObjectInteractable>(FindObjectsSortMode.None);
        ...
        ObjectObjectiveInteractable[] objectivesInteractable = FindObjectsByType<ObjectObjectiveInteractable>(FindObjectsSortMode.None);
